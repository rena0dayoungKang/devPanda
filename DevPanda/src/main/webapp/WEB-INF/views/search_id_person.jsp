            ...
            if(result==$('#certification').val()){
              ...
              if(successcount==0){
            	  ...
            	  input_error_title_2.id='success';
          		  ...
          		  id_button.removeAttribute('type');
          		  successcount++;
              }
...
<body>
	...
	<div class="entire-container">
		...
		<div class="container">
			<div class="sub-title">아이디찾기</div>
		</div>
		<div class="hr-container">
			<div class="hr-content-container">
				<hr style="width: 100%;">
				<div>
					등록된 이메일을 입력하시면 이메일로 인증번호를 발송합니다
				</div>
			</div>
		</div>
		<form class="form" id="form" method="get" action="/DevPanda/Person/IdResult" >
			...
			<div class="form-container" name='password'id='password'>
				<button  id='id-button' type='button'class="sign-in"  >개인회원 아이디 찾기</button>
			</div>
		</form>
	</div>
</body>
